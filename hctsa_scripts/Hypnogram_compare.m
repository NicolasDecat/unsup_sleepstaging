...
plot(x_time,original_labels,'r','LineWidth',2.8,'Color',[1 .5 .5])  % light red
ax.XTick = 1:120:1374;
...
hold on
plot(x_time,cluster_decision,'k','LineWidth',1,'Color',[.3 .3 .3])  % light grey
