...
Subs = {'458'}; % {'001' '005' '439' '458' '596' '748' '749' '752' '604' '807' '821' '870'};
...
for D = 1:length(Subs)
    ...
    for v = 1:3   % For each channel condition
        ...
        [statsOut testMat scoredTest predictTest Nf Iteration NumChannels Dataset Sleep_stage Testing_accuracy AUC] = cross_validation_selectivefeatures_permut(k, hctsa_ops, CM_SAVE_DIR, c, epochSelectFunc, SELECT_TOP_200_FEATURES,sub,v);
