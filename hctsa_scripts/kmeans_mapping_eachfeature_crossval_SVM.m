...
function [testMat Nf testTS trainTS trainMat label stats iteration_svm_testing_accuracy_MEAN] = cross_validation_selectivefeatures_crossval_eachall_SVM(experiment, hctsa_ops, cm_save_dir, number_of_channels_used, epochSelectFunction, selective_feature,sub,v,col,FF)
...
%% Compute type1AUC
   ...
   run('type1auc_eachfeature_crossval_SVM.m')
