...
%%%%%%% l.107 : selection of the first 1374 (EEG-only time series) for
%%%%%%% dataset 001. 
%%%%%%% Need to do TS_LabelGroups before
...
% Let's use only the EEG-only time series 
% TimeSeries = TimeSeries(1:1442,:);
% TS_DataMat = TS_DataMat(1:1442,:);
