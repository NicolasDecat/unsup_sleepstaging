...
function [testMat Nf testTS Per_correct_mean] = cross_validation_selectivefeatures_crossval(experiment, hctsa_ops, cm_save_dir, number_of_channels_used, epochSelectFunction, selective_feature,sub,v,col,FF)
