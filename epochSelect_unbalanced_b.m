...
function [trainTS, testTS] = epochSelect_unbalanced_b(stgID,pTraining)
% Stage labels
stgLab = {'W','N1','N2','N3','R'};
...
randIndex = randperm(length(stgID.selectID), trainPP * length(stgLab));

trainTS = stgID.selectID(randIndex);
