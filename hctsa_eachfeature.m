...
for nn = 1:1000
    means(nn) = mean(AUC(:,nn));
end

[~,I] = sort((means)','ascend');   % I is the ID of features that give the lowest AUC to features that give the highest AUC
